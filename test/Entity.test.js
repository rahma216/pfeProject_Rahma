...
describe('Model Service Test Suite', () => {
  ...
  it('should delete an entity', async () => {
    const dataToDelete = { ID: "100" }; // Assuming 'ID' is the primary key for entity identification
  ...
  it('should create a field with entity reference', async () => {
    // Assurez-vous que l'entité référencée existe
    const orderData = {
        ID: "100", // Assurez-vous que cet ID est unique et conforme à vos contraintes de base de données
        name: "Sample Order"
    };
...
it('should delete a field', async () => {
  const dataToDelete = { ID: "555" }; // Assuming 'ID' is the primary key for entity identification
...
it.only('should update a field', async () => {
